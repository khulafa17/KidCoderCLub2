          ...
          {classes.map((cls, index) => (
            ...
            >
              ...
              <div className="border-t pt-6">
                ...
                <button className={`w-full bg-gradient-to-r ${cls.color} text-white py-3 rounded-xl font-bold hover:shadow-lg transition-all duration-300 transform hover:scale-105`}>
                  Daftar Sekarang
                </button>
              </div>
            </div>

          ...
          {mentors.map((mentor, index) => (
            ...
            >
              ...
              <div className="text-center">
                ...
                <button className={`w-full bg-gradient-to-r ${mentor.color} text-white py-3 rounded-xl font-bold hover:shadow-lg transition-all duration-300 transform hover:scale-105`}>
                  Lihat Profil
                </button>
              </div>
            </div>
